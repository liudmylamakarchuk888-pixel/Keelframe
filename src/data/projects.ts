...
export const projects: Project[] = [
    ...
    {id:'gather',kind:'app',name:'Gather',cat:'FinTech · Investing',year:'2025',platform:'iOS & Android',img:'gather.webp',
     ...
     stat:'6 months · FCA-ready · Seed round raised 8 weeks after launch',
     stats:[['Timeline','6 months'],['Platform','iOS & Android'],['Outcome','Seed round in 8 weeks']],
     challenge:'Traditional investment platforms can feel complex and intimidating, especially for first-time investors. The goal was a simple, engaging investment experience that gave clear guidance — inside a product that had to satisfy strict FCA requirements from day one.',
     scope:[
       ...
       ['Development','Native-quality iOS and Android apps with multi-currency portfolios, curated expert-managed strategies, an educational content feed, and a community network — all built with compliance and security at the core.']],
    ...
    {id:'baysmokes',kind:'shopify',name:'Bay Smokes',cat:'Shopify · Hemp & wellness',year:'Live',platform:'Web store',img:'baysmokes.webp',
     ...
     challenge:'A national online hemp retailer serving customers at scale, operating in a complex regulatory environment. The store had to convert like a mainstream DTC brand — reviews, rewards, bundles, fast pages — while supporting state-specific shipping requirements, clear lab-testing information, and the sudden traffic spikes that follow drops and major marketing campaigns.',
     scope:[
       ['Storefront','A custom Shopify theme with a bold, sky-blue identity: category-led navigation, product carousels and video-commerce blocks, kept fast and maintainable with lazy loading and a deliberately lightweight app architecture.'],
     ...
     stack:['Shopify','Liquid','Cloudflare','HTTP/3','CSP','Klaviyo','Yotpo','Gorgias','VideoWise'],
